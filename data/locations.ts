...
export const CITIES: Record<string, string[]> = {
  ...
  "Aydın": ["Efeler", "Nazilli", "Söke", "Kuşadası", "Didim", "Çine", "İncirliova", "Germencik", "Bozdoğan", "Köşk", "Kuyucak", "Sultanhisar", "Karacasu", "Yenipazar", "Buharkent", "Karpuzlu"],
  ...
  "Konya": ["Selçuklu", "Meram", "Karatay", "Ereğli", "Akşehir", "Beyşehir", "Çumra", "Seydişehir", "Ilgın", "Cihanbeyli", "Kulu", "Karapınar", "Kadınhanı", "Sarayönü", "Bozkır", "Yunak", "Doğanhisar", "Hüyük", "Altınekin", "Hadim", "Çeltik", "Güneysınır", "Emirgazi", "Taşkent", "Tuzlukçu", "Derebucak", "Akören", "Ahırlı", "Halkapınar", "Derbent", "Yalıhüyük"],
  ...
  "Kahramanmaraş": ["Onikişubat", "Dulkadiroğlu", "Elbistan", "Afşin", "Türkoğlu", "Pazarcık", "Göksun", "Andırın", "Çağlayancerit", "Türkoğlu", "Nurhak", "Ekinözü"],
  ...
  "Ordu": ["Altınordu", "Ünye", "Fatsa", "Perşembe", "Kumru", "Korgan", "Gölköy", "Ulubey", "Mesudiye", "Aybastı", "İkizce", "Akkuş", "Gürgentepe", "Çatalpınar", "Çaybaşı", "Kabataş", "Kabadüz", "Çamaş", "Gülyalı"],
